...
export const IndividualTemplateItem = ({
  ...
  return (
    <Disclosure key={routine.template_id}>
      {({ open }) => (
        <>
          <Disclosure.Button className="flex items-center justify-center px-4 py-2 text-sm font-medium text-white/70 bg-black rounded-md bg-opacity-20 hover:bg-opacity-30 focus:outline-none focus-visible:ring-2 focus-visible:ring-white focus-visible:ring-opacity-75 space-x-3 w-full">
