...
export const Header = ({ currentUser }: { currentUser: User }): JSX.Element => {
  return (
    <div className="flex py-3 items-center justify-evenly flex-1 max-w-7xl">
      ...
      <div>
        ...
        >
          <div>
            <Menu.Button className="inline-flex justify-center w-full px-4 py-2.5 text-sm font-medium rounded-md bg-black bg-opacity-[0.19] hover:bg-opacity-40 focus:outline-none focus-visible:ring-2 focus-visible:ring-white focus-visible:ring-opacity-75">
              <DotsVerticalIcon
          ...
          >
            <Menu.Items className="absolute right-0 w-56 mt-2 origin-top-right bg-black bg-opacity-[0.19] hover:bg-opacity-40 divide-gray-100 rounded-md shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none">
